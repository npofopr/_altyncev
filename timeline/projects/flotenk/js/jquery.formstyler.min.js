...
(function(c){c.fn.styler=function(k){k=c.extend({browseText:"\u0412\u044b\u0431\u0440\u0430\u0442\u044c",zIndex:"50"},k);return this.each(function(){var a=c(this);a.is(":checkbox")?a.css({position:"absolute",left:-9999}).each(function(){if(1>a.next("span.checkbox").length){var b=c('<span class="checkbox" style="display:inline-block"><span></span></span>');a.after(b);a.is(":checked")&&b.addClass("checked");a.is(":disabled")&&b.addClass("disabled");b.click(function(){if(!b.is(".disabled"))return a.is(":checked")?
